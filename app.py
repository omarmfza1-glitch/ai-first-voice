# app.py — مركز اتصال ذكي متكامل (النسخة النهائية v9 - The Real One)
# -*- coding: utf-8 -*-
...
async def media_stream_handler(ws: WebSocket):
    ...
    # هذه المهمة تستقبل الصوت فقط وتضعه في الطابور
        ...
        try:
            while True:
                ...
                if event == "start":
                    ...
                    await queue.put(None) # إشارة النهاية
                    break
        except WebSocketDisconnect:
            logger.info("WS receiver disconnected.")
            await queue.put(None)
        except Exception as e:
            logger.error(f"WS receiver error: {e}")
            await queue.put(None)

    # هذه المهمة تسحب الصوت من الطابور وترسله إلى Google
...
# ... باقي الكود من القسم 8 إلى 12 لم يتغير ...
# ============================================================================
